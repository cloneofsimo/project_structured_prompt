...
def adjust_bounding_box_and_caption_complex(
    noun_chunks,
    caption,
    original_width,
    original_height,
    ...
    offset_y = (
        (original_height - crop_height) / 2 if original_height > crop_height else 0
    )
...
class ImageDataset(Dataset):
    ...
    def __getitem__(self, idx):
        ...
        caption = adjust_bounding_box_and_caption_complex(
            noun_chunks,
            caption,
            original_width,
            original_height,
