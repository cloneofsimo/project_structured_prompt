img2dataset --url_list /root/project_structured_prompt/stage_2_gligen_train/GRIT/grit-20m --input_format "parquet" \
    ...
    --min_image_size 512 --resize_only_if_bigger=False --resize_mode="keep_ratio" --skip_reencode=True \
